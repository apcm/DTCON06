...
public class FinderService {
	...
	public Finder saveResultsFixUpTasks(final Finder finder) {
		...
		if (finder.getCategory() != null || finder.getCategory() != "") {
			...
			results.retainAll(this.fixUpTaskService.fixUpTaskFilterByCategory(finder.getCategory()));
		}
		if (finder.getWarranty() != "" || !finder.getWarranty().isEmpty()) {
			System.out.println("caso 3");
			results.retainAll(this.fixUpTaskService.fixUpTaskFilterByWarranty(finder.getWarranty()));
		}
