...
public class CustomisationService {
	...
	public void delete(final Customisation c) {
		this.customisationRepository.delete(c);
	}

	public Customisation findOne(final Customisation c) {
		return this.customisationRepository.findOne(c.getId());
	}
}
